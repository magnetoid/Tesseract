        ...
        <Dialog.Content className="fixed top-[20%] left-1/2 -translate-x-1/2 w-full max-w-lg bg-surface border border-default rounded-xl shadow-2xl z-[101] overflow-hidden animate-in zoom-in-95 duration-200">
          <Command className="flex flex-col h-full">
            ...
            <Command.List className="max-h-[300px] overflow-y-auto p-2 no-scrollbar">
              ...
              <Command.Group heading="Tools" className="px-2 py-1.5 text-[10px] font-bold text-tertiary uppercase tracking-widest">
              ...
              <Command.Group heading="Files" className="px-2 py-1.5 text-[10px] font-bold text-tertiary uppercase tracking-widest mt-2">
                {files.map(file => (
                  <Item 
                    key={file.id} 
              ...
              <Command.Group heading="Actions" className="px-2 py-1.5 text-[10px] font-bold text-tertiary uppercase tracking-widest mt-2">
              ...
              <Command.Group heading="Agent" className="px-2 py-1.5 text-[10px] font-bold text-tertiary uppercase tracking-widest mt-2">
...
function Item({ icon, label, shortcut, onSelect }: { icon: React.ReactNode, label: string, shortcut?: string, onSelect: () => void }) {
  return (
    ...
    >
      <span className="text-secondary group-hover:text-accent-hover">{icon}</span>

export const usageMock = {
  ...
  teamMembers: [
    ...
    { id: 'u2', name: 'Sarah Chen', email: 'sarah.c@torsor.ai', role: 'admin', avatar: 'https://i.pravatar.cc/150?u=sarah', lastActive: '2m ago', status: 'online' },
    { id: 'u3', name: 'Alex Rivera', email: 'alex.r@torsor.ai', role: 'developer', avatar: 'https://i.pravatar.cc/150?u=alex', lastActive: '1h ago', status: 'offline' },
    { id: 'u4', name: 'Jordan Smith', email: 'jordan.s@torsor.ai', role: 'developer', avatar: 'https://i.pravatar.cc/150?u=jordan', lastActive: '3h ago', status: 'online' },
    { id: 'u5', name: 'Elena Vance', email: 'elena.v@torsor.ai', role: 'viewer', avatar: 'https://i.pravatar.cc/150?u=elena', lastActive: '1d ago', status: 'offline' },
    { id: 'u6', name: 'Marcus Wright', email: 'marcus.w@torsor.ai', role: 'developer', avatar: 'https://i.pravatar.cc/150?u=marcus', lastActive: '2d ago', status: 'offline' },
  ],
  pendingInvites: [
    { email: 'david.k@torsor.ai', role: 'developer', sentDate: 'Mar 15, 2026', status: 'pending' },
    { email: 'lisa.m@torsor.ai', role: 'viewer', sentDate: 'Mar 10, 2026', status: 'expired' },
  ],
  auditLogs: [
    { id: 'l1', timestamp: '2026-03-16 19:45:22', user: { name: 'Marko Tiosavljevic', avatar: 'https://i.pravatar.cc/150?u=marko' }, action: 'project_create', resource: 'Torsor AI Platform', ipAddress: '192.168.1.1' },
    { id: 'l2', timestamp: '2026-03-16 18:30:10', user: { name: 'Sarah Chen', avatar: 'https://i.pravatar.cc/150?u=sarah' }, action: 'invite_sent', resource: 'david.k@torsor.ai', ipAddress: '192.168.1.42' },
    ...
    { id: 'l13', timestamp: '2026-03-15 22:45:22', user: { name: 'Marko Tiosavljevic', avatar: 'https://i.pravatar.cc/150?u=marko' }, action: 'deploy', resource: 'Torsor Core', ipAddress: '192.168.1.1' },
